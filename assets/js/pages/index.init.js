...
document.querySelector("#location").addEventListener("input", async (e) => {
  ...
  try {
    ...
    showToast("Error sending location", false); // Generic error message
    console.error("Error sending location:", error);
  }
});

//handle bio change
document.querySelector("#bio").addEventListener("input", async (e) => {
  ...
  try {
    ...
    showToast("Error sending Bio", false); // Generic error message
    console.error("Error sending Bio:", error);
  }
});
...
async function handleLogout() {
  try {
    ...
    showToast("Logout failed. Internal error.");
    console.error("Error during logout:", error);
  }
}
// Handle status of profile
const mainStatus = document.querySelector(".main-status");
document.querySelectorAll(".status-option").forEach((e) => {
  e.addEventListener("click", async () => {
    const status = e.textContent.split(/\s+/).join("");
    mainStatus.innerHTML = e.innerHTML;
    try {
      ...
      showToast("Failed to update status. Internal error.", false);
    }
  });
});
  ...
  t && (document.getElementById(t).checked = !0),
    document.querySelectorAll(".theme-color").forEach(function (i) {
      ...
      a &&
        ...
        (rgbColorSecondary = t.substring(t.indexOf("b") + 2, t.indexOf(")"))),
    ...
    document.querySelectorAll(".colorpicker-secondary").forEach(function () {
...
!(function () {
              ...
              document
                ...
                .forEach(function (e) {
                  i
                    ...
                    : e.querySelector("img").setAttribute("src", o);
                }),
                window.stop();
            });
          }),
                ...
                i.querySelectorAll(".delete-item").forEach(function (e) {
                  ...
                  i.querySelectorAll(".download-file").forEach(function (i) {
                    i.addEventListener("click", function (e) {
                      ...
                      window.FileList &&
                      window.Blob
                        ? ((t = new Blob([j[s]], { type: "application/pdf" })),
  ...
  function I(e, t, a, s, i, l, o) {
    ...
    if (null != t)
      ...
      for (r += '<div class="message-img mb-0">', M = 0; M < a.length; M++)
        r +=
          '<div class="message-img-list">            <div>              <a class="popup-img d-inline-block" href="' +
          a[M] +
          '">                <img src="' +
